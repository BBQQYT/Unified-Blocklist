<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/github/stars/ВАШ_НИК/ИМЯ_РЕПО?style=for-the-badge&color=ff6b6b" />
    <img src="https://img.shields.io/github/last-commit/ВАШ_НИК/ИМЯ_РЕПО?style=for-the-badge&color=6366f1" />
    <img src="https://img.shields.io/github/license/ВАШ_НИК/ИМЯ_РЕПО?style=for-the-badge&color=10b981" />
  </p>
</div>
...
**Unified Blocklist** — это автоматизированный инструмент для сборки единого, очищенного от дубликатов списка блокировки нежелательных доменов и рекламы. 
...
- 🗜️ **Дедупликация:** Объединяет миллионы строк в единый уникальный массив.
- 📦 **Два формата на выбор:**
  - `domains.txt` — только чистые домены (идеально для AdGuard Home, NextDNS, sing-box).
...
* **Список доменов:** `https://raw.githubusercontent.com/ВАШ_НИК/ИМЯ_РЕПО/main/domains.txt`
* **Формат Hosts:** `https://raw.githubusercontent.com/ВАШ_НИК/ИМЯ_РЕПО/main/hosts.txt`
...
- 💎 **[HaGeZi](https://github.com/hagezi/dns-blocklists)** — за ультимативные листы `ultimate` и `dyndns` (лучшая защита от трекеров).
...
Скрипт сборщика распространяется под лицензией MIT. Права на сами блокируемые домены принадлежат авторам оригинальных списков.
